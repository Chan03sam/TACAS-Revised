    ...
    <nav style="position: absolute; width: 99%; z-index: 2000;">
        ...
        <div class="row">
            ...
            <button class="btn btn-success bg-green col-md-1">
                <a href="./admin/login.php">To Admin</a>
            </button>
        </div>
    </nav>
        ...
        <div class="w-100 d-flex justify-content-center align-items-center h-100 text-navy">
            <div class="card card-outline card-success rounded-0 shadow col-lg-10 col-md-10 col-sm-5">
                <div class="card-header">
                    <h5 class="card-title text-center text-dark"><b>Login - OUTSIDERS</b></h5>
                </div>
                <div class="card-body">
                    <form action="" id="slogin-form">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <a href="./payment.php" style="color: green;">Click for Payment</a>
                             </div>
...
<script>
  $(document).ready(function(){
    ...
    $('#slogin-form').submit(function(e){
        ...
        formData += "&session_time=" + $("#session_time").val();

        start_loader();
        $.ajax({
            url:_base_url_+"classes/Login.php?f=outsiders_login",
            method:'POST',
