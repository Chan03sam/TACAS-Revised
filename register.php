...
<div class="h-100 d-flex  align-items-center w-100" id="login">
    <div class="col-7 h-100 d-flex align-items-center justify-content-center">
      <div class="w-100">
        <center><img src="./uploads/tac.png"></center>
      </div>
                ...
                <div class="card-body">
                    <form action="" id="registration-form">
                        ...
                        <div class="row">
                            <div class="form-group col-auto">
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input" type="radio" id="userTypeStudent" name="user_type" value="student" required checked>
                                    <label for="userTypeStudent" class="custom-control-label">Student</label>
                                </div>
                            </div>
                            <div class="form-group col-auto">
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input" type="radio" id="userTypeOutsider" name="user_type" value="outsider">
                                    <label for="userTypeOutsider" class="custom-control-label">Outsider</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
<script>
        ...
        $(document).ready(function(){
            ...
            function handleStudentRegistration() {
                ...
                if (userType === 'student' && email.indexOf("@asiatech.edu.ph") === -1) {
                    el.addClass("alert-danger");
                    el.text("Only @asiatech.edu.ph emails are allowed for students.");
