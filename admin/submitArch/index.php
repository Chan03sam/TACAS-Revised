            ...
            <div class="container-fluid">
                <form action="" id="archive-form">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="title" class="control-label text-navy">Archive Code</label>
                                <input type="text" name="archive_code" id="archive_code" autofocus placeholder="Project Title" class="form-control form-control-border" value="<?= isset($archive_code) ?$archive_code : "" ?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
