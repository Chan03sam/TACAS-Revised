...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand bg-dark" >
        ...
        <!-- Sidebar -->
        <div class="sidebar os-host os-theme-light os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-transition os-host-scrollbar-horizontal-hidden" style="background-color: #114e3f">
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=submitArch" class="nav-link nav-submitArch">
                        <i class="nav-icon fas fa-archive"></i>
                        <p>
                          Submit Archive/Thesis
                        </p>
                      </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=outsiders" class="nav-link nav-outsiders">
