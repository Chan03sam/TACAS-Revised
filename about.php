            ...
            <div class="col-md-3">
                <div class="creator-card card h-80">
                    <center>
                        ...
                        <div class="card-body">
                                <p style="font-size: 15px; font-weight: 500; width: 100%;">ARAMBULO, JOSHUA</p>
                                <p style="font-size: 15px; font-weight: 500; width: 100%;"><i>BSIT</i></p>
                                <p style="font-size: 15px; font-weight: 500; width: 100%;">BATCH 2024</p>
                        </div>
                    </center>
                </div>
            </div>
            <div class="col-md-3">
                <div class="creator-card card h-80">
                    <center>
                        ...
                        <div class="card-body">
                            <p style="font-size: 15px; font-weight: 500; width: 100%;">DACOROON, JADE MAUREEN</p>
                            <p style="font-size: 15px; font-weight: 500; width: 100%;"><i>BSIT</i></p>
                            <p style="font-size: 15px; font-weight: 500; width: 100%;">BATCH 2024</p>
                        </div>
                    </center>
            ...
            <div class="col-md-3">
                <div class="creator-card card h-80">
                    <center>
                        ...
                        <div class="card-body">
                            <p style="font-size: 15px; font-weight: 500; width: 100%;">EBRO, ANNE GELINE</p>
                            <p style="font-size: 15px; font-weight: 500; width: 100%;"><i>BSIT</i></p>
                            <p style="font-size: 15px; font-weight: 500; width: 100%;">BATCH 2024</p>
                        </div>
                    </center>
            ...
            <div class="col-md-3">
                <div class="creator-card card h-80">
                    <center>
                        ...
                        <div class="card-body">
                            <p style="font-size: 15px; font-weight: 500; width: 100%;">LUCAS, PABLO III</p>
                            <p style="font-size: 15px; font-weight: 500; width: 100%;"><i>BSIT</i></p>
                            <p style="font-size: 15px; font-weight: 500; width: 100%;">BATCH 2024</p>
                        </div>
                    </center>
